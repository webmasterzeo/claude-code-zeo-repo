# Agency Skills voor Claude Code
...
```bash
git clone https://github.com/webmasterzeo/claude-agency-skills.git
```

### 2. Start Claude Code vanuit de repo

```bash
cd claude-agency-skills
claude
```
...
- **Skills verschijnen niet?** Zorg dat je Claude Code start vanuit de `claude-agency-skills` map, niet vanuit een andere directory.
